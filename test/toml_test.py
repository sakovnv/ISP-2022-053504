...
from src import TomlSerializer
from test import tested_data as data

serializer = TomlSerializer()

FILE_PATH = "/home/sakovnv/PycharmProjects/ISP-Lab-2/file.toml"
...
class TomlTest(TestCase):
    ...
    def test_class(self):
        obj = serializer.dumps(data.TestClass)
        self.assertNotIsInstance(obj, data.TestClass)
